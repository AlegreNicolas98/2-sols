  ...
  return (
    <div className='footer' >
        ...
        <div>
          ...
          <ul><li className='lista'>	M. Altolaguirre 387 - tel: 2063.2555 wsp: 11.6886.4108- Tapiales</li></ul>
      ...
      <div>
        ...
        <img className='imagen'src="https://osm.cylex-international.com/osm/staticmaplite/staticmap.php?center=-34.70093653,-58.51018068&zoom=15&size=xy&maptype=tm&markers=-34.70093653,-58.51018068,marker-34" alt=""  width='130%' height='100%' />
        </a>
      </div>
    </div>
